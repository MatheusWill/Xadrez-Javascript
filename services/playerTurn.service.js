export const playerTurn = {
  ...
  changeTurn() {
    if (this.isWhiteTurn) this.whosTurn = "black";
    else if (this.isBlackTurn) this.whosTurn = "white";
  },
  isWrongTurn(pieceType) {
    if (this.isWhiteTurn && this.isBlackPiece(pieceType)) return true;
    else if (this.isBlackTurn && this.isWhitePiece(pieceType)) return true;
